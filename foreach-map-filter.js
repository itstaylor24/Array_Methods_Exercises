...
*/
const nums = [22, 34, 2, 6, 7, 98, 56, 23, 46, 98];
...
object with the keys as the vowel and the values as the number of times
 the vowel appears in the string. This function should be case
...
function vowelCount(str) {
  ...
  const splitArr = lowercased.split("");
  let obj = {};
  const vowels = "aeiou";
...
// cannot return only first instance
...
function removeVowels(str) {
  const splitlowStr = str.toLowerCase().split("");
  const vowels = "aeiou";
